    ...
    <>
      <div className="container  bg-gray-100 text-gray-900 flex flex-row min-h-screen  w-full justify-center items-center">
        ...
        <h1 class="text-2xl xl:text-3xl font-bold mb-4">
          ...
          >
            {({ errors, touched }) => (
              <Form className="h-5/6 w-5/6  bg-gray-200 bg-opacity-30 rounded-md border shadow-lg py-16 px-7 mb-20">
                ...
                <Field className="w-full px-8 py-4 -mt-2 focus:border-yellow-500  rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none  focus:bg-white" name="Email" placeholder="Email" />
                {errors.phoneNumber && touched.phoneNumber ? (
                  <div>{errors.phoneNumber}</div>
                ) : null}
                <Field className="w-full px-8 py-4 focus:border-yellow-500 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:bg-white mt-7" name="password" type="password" placeholder="Password" />
          ...
          <label className="text-sm mt-1 " for="remember"> <p>Remember me</p></label>
        </div>
                <button className="mt-9 tracking-wide font-bold bg-yellow-500 text-gray-800 w-full py-4 rounded-lg hover:bg-gray-800  hover:text-white transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none" type="submit">
                {/* <svg
                  class="w-6 h-6 -ml-2"
                  fill="none"
                  stroke="currentColor"
